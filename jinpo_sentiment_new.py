...
DEFAULT_DATA_FILE = './data/CellPhoneReview.json'
...
def main(data_file, seed):
    df = pd.read_json(data_file, orient='columns', lines=True)
    df['sentences'] = df['reviewText'].apply(segment_sent)
    df['sentenceCount'] = df['sentences'].apply(len)
    df['tokenizedSentences'] = df['sentences'].apply(lambda sentences: [tokenize(sentence, stemmer = None, lower = True, remove_punc = True, remove_stopwords = True, remove_emoji = False) for sentence in sentences])
    ...
    print(OrderedDict(sorted(score_it_dict.items(), key=lambda t: t[1], reverse=True)))
...
# counter_rating4 = {}
# counter_rating5 = {}
# df_rating1 = df[df['overall']==1]
# df_rating1.index = range(len(df_rating1))
# df_rating2 = df[df['overall']==2]
# df_rating2.index = range(len(df_rating2))
# df_rating4 = df[df['overall']==4]
# df_rating4.index = range(len(df_rating4))
# df_rating5 = df[df['overall']==5]
# df_rating5.index = range(len(df_rating5))
#
# for i in range(len(df_rating1)):
#     counter_rating1[i] = (Counter(df_rating1['tokens'][i]),len(df_rating1['tokens'][i]))
# for i in range(len(df_rating2)):
#     counter_rating2[i] = (Counter(df_rating2['tokens'][i]),len(df_rating2['tokens'][i]))
# for i in range(len(df_rating4)):
#     counter_rating4[i] = (Counter(df_rating4['tokens'][i]),len(df_rating4['tokens'][i]))
# for i in range(len(df_rating5)):
#     counter_rating5[i] = (Counter(df_rating5['tokens'][i]),len(df_rating5['tokens'][i]))
#
#
#
# def score_it(word,gamma = 4):
#
#     def relative_term_frequency_document_frequency(counterDict,word):
#         rtfWord = 0
#         dfWord = 0
#         for items in list(counterDict.values()):
#             wordCount = items[0][word]
#             if wordCount > 0:
#                 dfWord += 1
#             rtfWord +=  (wordCount/items[1])
#         return (rtfWord,dfWord)
#     relative_term_frequency_document_frequency1, document_frequency_rating1 = relative_term_frequency_document_frequency(counter_rating1,word)
#     relative_term_frequency_document_frequency2, document_frequency_rating2 = relative_term_frequency_document_frequency(counter_rating2,word)
#     relative_term_frequency_document_frequency4, document_frequency_rating4 = relative_term_frequency_document_frequency(counter_rating4,word)
#     relative_term_frequency_document_frequency5, document_frequency_rating5 = relative_term_frequency_document_frequency(counter_rating5,word)
#
#     documentFrequencyWord = document_frequency_rating1 + document_frequency_rating2 + document_frequency_rating4 + document_frequency_rating5
#
#     balanced_relative_term_frequency_rating1 = relative_term_frequency_document_frequency1 / reviewCountNeg * reviewCountN
#     balanced_relative_term_frequency_rating2 = relative_term_frequency_document_frequency2 / reviewCountNeg * reviewCountN
#     balanced_relative_term_frequency_rating4 = relative_term_frequency_document_frequency4 / reviewCountPos * reviewCountN
#     balanced_relative_term_frequency_rating5 = relative_term_frequency_document_frequency5 / reviewCountPos * reviewCountN
#
#     posWord = gamma * balanced_relative_term_frequency_rating5 + balanced_relative_term_frequency_rating4
#     negWord = gamma * balanced_relative_term_frequency_rating1 + balanced_relative_term_frequency_rating2
#     idfWord = math.log(reviewCountN/documentFrequencyWord)
#     return ((posWord - negWord) * idfWord)
#
#
# score_it('problem')
...
if __name__ == '__main__':
    ...
    main(DEFAULT_DATA_FILE, DEFAULT_SEED)
